...
- [OneBot](https://github.com/botuniverse/onebot) (2020-now): A chatbot API standard derived from the documentation of CQHTTP, after the closing of CoolQ chatbot platform. Now it has 0.7k stars on GitHub.
